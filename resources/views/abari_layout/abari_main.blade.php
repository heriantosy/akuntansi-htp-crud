...
<html lang="en">
  ...
  <body>
     <!-- start lwh nav -->
        ...
        <div class="container">
            <a class="navbar-brand" href="#">ABDUL BARI's Project</a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link {{ request()->segment('1')=='' || request()->segment('1') == 'home' ? 'active' : '' }}" aria-current="page" href="{{ url('abari/home') }}">
                <i class="fas fa-tachometer-alt"></i>Home</a>
                </li>

                <li class="nav-item">
                <a class="nav-link {{ request()->segment('1') =='abari'  ? 'active' : '' }}" aria-current="page" href="{{ url('abari_akun') }}">
                <i class="fas fa-user"></i>Modul Perkiraan</a>
                </li> 
